      ...
      transition: 'opacity 0.1s ease-out'
        ...
        <div className="max-w-4xl mx-auto pt-0 md:pt-0 -mt-8 md:-mt-16">
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl leading-tight mb-4 md:mb-6 font-extrabold tracking-tight animate-fade-up">
            <span className="text-foreground drop-shadow-lg">Perdu dans l'IA et les nouveaux outils </span>
          ...
          animationDelay: '100ms'
            ...
            <p className="text-base sm:text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">
              Summit Flow guide vos équipes terrain pour transformer votre désordre organisé en trajectoire claire, grâce au no-code, à l'automatisation et à l'IA.
            </p>
          </div>
          ...
          animationDelay: '200ms'
            ...
            <a href="#solutions-no-code-ia-toulouse" className="inline-flex items-center justify-center gap-2 px-5 sm:px-6 py-3 rounded-full font-semibold text-base transition-all duration-300 border border-border hover:border-primary/50 hover:scale-105 backdrop-blur-sm text-primary-foreground bg-primary">
