    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-b from-background to-muted/30 pt-16 md:pt-0">
      ...
      >
        <div className="max-w-4xl mx-auto pt-8 md:pt-0">
          ...
          <div className="inline-block bg-background/80 backdrop-blur-sm rounded-2xl border border-border/40 px-4 sm:px-6 py-3 md:py-4 shadow-lg shadow-primary/10 mb-6 md:mb-8 animate-fade-up" style={{ animationDelay: '100ms' }}>
            <p className="text-base sm:text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">
              Transformez vos processus, créez vos outils et automatisez votre activité.
            </p>
          </div>

          <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center px-4 animate-fade-up" style={{ animationDelay: '200ms' }}>
            <a 
      ...
      <div 
        className={cn(
          "absolute left-1/2 -translate-x-1/2 w-[140%] sm:w-[130%] md:w-[120%] max-w-[1600px] z-20 pointer-events-none",
          isMobile ? "bottom-0" : ""
        )}
        style={{ 
