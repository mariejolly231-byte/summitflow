      ...
      transition: 'opacity 0.1s ease-out'
        ...
        <div className="max-w-4xl mx-auto pt-0 md:pt-0 -mt-8 md:-mt-16">
          ...
          animationDelay: '200ms'
            ...
            <a href="#rentabilite-no-code-pme" className="inline-flex items-center justify-center gap-2 px-5 sm:px-6 py-3 rounded-full font-semibold text-base transition-all duration-300 border border-border hover:border-primary/50 hover:scale-105 backdrop-blur-sm text-primary-foreground bg-primary-light">
