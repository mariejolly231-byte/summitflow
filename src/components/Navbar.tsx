          ...
          <div className="hidden md:flex items-center gap-4 lg:gap-6">
            {navLinks.map(link => (
              <a 
                key={link.href} 
                href={link.href} 
                className="text-muted-foreground hover:text-primary transition-colors font-medium text-xs lg:text-sm xl:text-base"
              >
                {link.label}
              </a>
            ))}
            ...
            <a 
              ...
              className="btn-hero text-xs lg:text-sm xl:text-base px-3 lg:px-4 xl:px-6 py-2 lg:py-2.5 xl:py-3 flex items-center gap-2"
            >
