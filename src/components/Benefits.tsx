...
const BenefitCard = ({
  ...
  index: number;
}) => <div className="text-center p-6 group animate-fade-up bg-card rounded-2xl shadow-md h-full flex flex-col items-center justify-start" style={{
...
const Benefits = () => {
  ...
  return <section className="py-12 md:py-16">
      <div className="container mx-auto">
        ...
        {isMobileOrTablet ? <MobileCarousel className="mb-8" showArrows={true}>
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-5 gap-6">
        ...
        <div className="text-center mt-8 md:mt-12 animate-fade-up" style={{
